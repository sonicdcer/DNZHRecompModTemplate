...
CPPFLAGS := -nostdinc -DVERSION_US -DTARGET_N64 -DF3DEX_GBI_2 -D_LANGUAGE_C -D_FINALROM -D_MIPS_SZLONG=32 -DMIPS -I include \
			-I dnzh/include -I dnzh/libs/libultra/include/2.0I
